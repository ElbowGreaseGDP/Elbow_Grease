...
const galleryImages = [
    "/Elbow_Grease/gallery/BB_and_freind.png",
    "/Elbow_Grease/gallery/Big_bertha_Label.png",
    "/Elbow_Grease/gallery/BB_Noback.png",
];
    ...
    return (
        <>
            <section
                ...
                style={{ backgroundImage: "url('/Elbow_Grease/gallery/BB_Noback.png')" }}
            >
                ...
                <div className="relative z-10 flex flex-col items-center justify-center h-full text-center px-4">
                    ...
                    >
                        Explore our cutting-edge prosthesis wear testing platform through interactive 3D simulation and high-fidelity renderings.
                    </motion.p>
                    <Link
                        href="/simulator"
